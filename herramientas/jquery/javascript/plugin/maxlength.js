...
jQuery(document).ready(function($){ //fire on DOM ready
	//var $targetfields=$("input[maxlength], textarea[maxlength]") //get INPUTs and TEXTAREAs on page with "maxlength" attr defined
    var $targetfields=$("textarea[maxlength]") //get INPUTs and TEXTAREAs on page with "maxlength" attr defined
