...
function cambia_zoom( valor ){
	
	console.log( proceso.document.body.style.zoom );
	//var zoom = proceso.document.body.style.zoom;
	if( proceso.document.body.style.zoom == '') proceso.document.body.style.zoom = '100%'; 
	else zoom = parseFloat( proceso.document.body.style.zoom );
