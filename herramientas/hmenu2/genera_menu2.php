...
if($grupo) $sql = "select id_m_menu,rotulo,posicion,url,target,icono,id_padre from v_i_menu_grup where id_m_grupos = '$grupo' order by posicion";
else $sql = "select * from m_menu order by posicion";
