...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="overflow-y:hidden;margin:0;padding:0;border:0;font-size:13px;font-family:\'Trebuchet MS\', Arial, Helvetica, sans-serif">
    ...
    <script>
        ...
        var agentsStr = ["Okänd", "Windows 32-bitars konsol", "Windows 64-bitars konsol", "Windows 32-bitars tjänst", "Windows 64-bitars tjänst", "Linux 32bit", "Linux 64bit", "MIPS", "XENx86", "Android ARM", "Linux ARM", "macOS x86-32bit", "Android x86", "PogoPlug ARM", "Android", "Linux Poky x86-32bit", "macOS x86-64bit", "ChromeOS", "Linux Poky x86-64bit", "Linux NoKVM x86-32bit", "Linux NoKVM x86-64bit", "Windows MinCore-konsol", "Windows MinCore-tjänst", "NodeJS", "ARM-Linaro", "ARMv6l / ARMv7l", "ARMv8 64bit", "ARMv6l / ARMv7l / NoKVM", "MIPS24KC (OpenWRT)", "Apple Silicon", "FreeBSD x86-64", "Okänd", "Linux ARM 64 bitar (glibc / 2,24 NOKVM)", "Alpine Linux x86 64 bitar (MUSL)", "Assistent (Windows)", "Armada370 - ARM32/HF (libc/2.26)", "OpenWRT x86-64", "OpenBSD x86-64", "Okänd", "Okänd", "MIPSEL24KC (OpenWRT)", "ARMADA / CORTEX-A53 / MUSL (OpenWRT)"];
        var files;
        var terminal;
