    ...
    <div id="p11" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none">
        <div id="deskarea0">
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" title="Latence relace na počítači"></span>
                    <span id="DeskTimer" style="display:none" title="Čas spojení"></span>&nbsp;
                ...
                <div id="d7meshkvm">
                    ...
                    <div id="d7desktopOtherSettings">
                        ...
                        <div id="d7otherset2" style="display:block">
                            <label style="display:block"><input type="checkbox" id="d7deskSwapMouse">Zaměňte tlačítka myši</label>
    ...
    <script>
        ...
        */
        ...
        function p13downloadfile(x, y, z, tag) {
            ...
            setDialogMode(2, "Stáhnout si soubor", 10, p13downloadFileCancel, '<div>' + gdownloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
