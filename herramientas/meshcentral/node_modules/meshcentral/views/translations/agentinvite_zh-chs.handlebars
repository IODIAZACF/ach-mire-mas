...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="display:none;overflow:hidden">
    <div id="container">
        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <p>
                您已被邀请安装一个应用程序，该应用程序将允许远程操作员安全地访问您的计算机，包括桌面和档案。如果预期会收到此邀请，请仅遵循以下说明，并且您知道谁将访问您的计算机。选择您的操作系统，然后按照以下说明进行安装。
            </p>
            <div>
                <div class="tab">
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    <h3>苹果™MacOS</h3>
                    <p><a id="macosurl">在此处下载安装程式</a>，右键单击它或按“控制”，然后单击档案。然后选择“打开”并遵循指示操作。</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="https://play.google.com/store/apps/details?id=com.meshcentral.agent2">谷歌商店</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="https://info.meshcentral.com/downloads/MeshCentral2/meshcentral-agent.apk">Android APK 下载</a>
                        </p>
                        <p>
