...
<body style="overflow:hidden;background-color:black">
    <div id="p11" class="noselect" style="overflow:hidden">
        <div id="deskarea0">
            <div id="deskarea1" class="areaHead">
                ...
                <div>
                    <input id="OpenFileButton" type="button" value="打开档案..." onclick="openfile()" style="display:none">
    ...
    <script>
        ...
        function cleanup() {
            ...
            QV('metadatadiv', true);
            if (urlargs.stream == null) {
                QH('metadatadiv', '<span style=\"font-family:Arial,Helvetica Neue,Helvetica,sans-serif;font-size:28px\">MeshCentral Session Player</span><br /><br /><span style=color:gray>' + "拖放.mcrec档案或单击 “打开档案...”" + '</span>');
            } else {
                QH('metadatadiv', '');
            }
            QV('DeskParent', true);
        ...
        function openfile() {
            ...
            setDialogMode(2, "打开档案...", 3, openfileEx, x);
