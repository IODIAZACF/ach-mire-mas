        ...
        <div id="column_l" style="overflow-y:auto">
            ...
            <div>
                ...
                <div id="macostab" class="tabcontent" style="background-color:white;color:black">
                    <h3>Apple™ MacOS</h3>
                    <p><a id="macosurl">Faça o download do instalador aqui</a>, clique com o botão direito do mouse ou pressione "control".Em seguida, selecione "Open".</p>
                    <div style="text-align:center">
                ...
                <div id="androtab" class="tabcontent" style="background-color:white;color:black">
                    ...
                    <div style="min-height:220px">
                        ...
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="https://play.google.com/store/apps/details?id=com.meshcentral.agent2">Loja de aplicativos do Google</a>
                        </p>
                        <p>
                            <a rel="noreferrer noopener" target="_blank" href="https://info.meshcentral.com/downloads/MeshCentral2/meshcentral-agent.apk">Download do APK Android</a>
                        </p>
                        <p>
