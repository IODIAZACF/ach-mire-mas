...
<body id="xbody">
    <div id="container">
        ...
        <div id="topbar" class="noselect style3">
            <div id="uiMenuButton" title="Výběr uživatelského rozhraní">
                ♦
                <div id="uiMenu">
                    <div id="uiViewButton1" class="uiSelector" title="Rozhraní s lištou vlevo"><div class="uiSelector1"></div></div>
                    <div id="uiViewButton2" class="uiSelector" title="Rozhraní s lištou nahoře"><div class="uiSelector2"></div></div>
                    <div id="uiViewButton3" class="uiSelector" title="Rozhraní s pevnou šířkou"><div class="uiSelector3"></div></div>
                    <div id="uiViewButton4" class="uiSelector" title="Vyp/zap. noční režim"><div class="uiSelector4"></div></div>
                </div>
            </div>
        </div>
        <div id="column_l">
            <div id="text1"><b>404</b></div>
            <div id="text2">Tato stránka neexistuje</div>
            <div id="text3"><a href="/" style="text-decoration:none"><b>Zpět na hlavní stránku</b></a></div>
        </div>
        <div id="footer">
            <table cellpadding="0" cellspacing="10" style="width: 100%">
                <tbody><tr>
                    <td id="footerLeft"></td>
                    <td id="footerRight"><a href="/">Zpět</a></td>
                </tr>
            </tbody></table>
        </div>
    </div>
