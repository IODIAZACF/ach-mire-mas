...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" style="overflow-y:hidden;margin:0;padding:0;border:0;font-size:13px;font-family:\'Trebuchet MS\', Arial, Helvetica, sans-serif">
                ...
                <div id="p2" style="display:none;position:absolute;top:0;left:0;right:0;bottom:0">
                    ...
                    <div id="xdevicesBar" style="position:absolute;overflow-y:auto;height:34px;left:0;right:0;bottom:0px;background-color:#aaa;color:black">
                        <div style="margin:4px">
                            ...
                            <label class="noselect"><input type="checkbox" id="OnlineCheckBox" onclick="onOnlineCheckBox(event)">线上</label>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="p3AccountActions">
                                ...
                                <div id="p2AccountActions" style="display:none">
                                    ...
                                    <div style="margin-left:9px;margin-bottom:8px">
                                        ...
                                        <div style="margin-top:5px"><span id="changeEmailId" style="display:none"><a onclick="account_showChangeEmail()" style="cursor:pointer">更改电邮地址</a></span></div>
                ...
                <div id="p5" style="display:none">
                    <table cellspacing="0" style="margin:0;padding:0;border-spacing:0;border:0;">
                        <tbody><tr style="padding:0">
                            ...
                            <td>
                                <div style="margin-left:5px">
                                    <strong style="font-size:large">我的档案</strong><br>
                                </div>
                            </td>
                        </tr>
                    </tbody></table>
                            ...
                            <tbody><tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5FolderUp" disabled="disabled" onclick="p5folderup()" value="向上">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5NewFolderButton" disabled="disabled" value="档案夹" onclick="p5createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p5UploadButton" disabled="disabled" value="上载" onclick="p5uploadFile()" onkeypress="return false" onkeydown="return false">
                    ...
                    <div id="p10files" style="position:absolute;top:55px;bottom:0px;width:100%;display:none">
                        <table id="p13toolbar" style="width:100%;height:111px" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td style="width:100%;background-color:#d3d9d6;text-align:left;padding:4px" valign="bottom">
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="向上">
                                        ...
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13NewFolderButton" disabled="disabled" value="档案夹" onclick="p13createfolder()" onkeypress="return false" onkeydown="return false">
                                    </div>
                                    <div style="width:100%;text-align:center">
                                        <input type="button" style="width:calc(100%/5 - 5px)" id="p13UploadButton" disabled="disabled" value="上载" onclick="p13uploadFile()" onkeypress="return false" onkeydown="return false">
    ...
    <div id="topMenu" style="z-index:1000;background-color:#EEE;box-shadow:0px 0px 15px #666;font-family:Arial,Helvetica,sans-serif;border-radius:0px 0px 5px 5px;position:fixed;top:50px;right:5px;width:170px;display:none">
        <div style="padding:12px;border-top:1px solid gray;color:black;cursor:pointer" onclick="topMenu(2)">我的档案</div>
    ...
    <script>
        ...
        function account_manageAuthEmail() {
            ...
            setDialogMode(2, "电邮认证", 1, function () {
        ...
        function account_showVerifyEmail() {
            ...
            setDialogMode(2, "电邮验证", 3, account_showVerifyEmailEx, x);
        }
        ...
        function account_showChangeEmail() {
            ...
            setDialogMode(2, "电邮地址变更", 3, account_changeEmail, x);
        ...
        function p5createfolder() { setDialogMode(2, "新建档案夹", 3, p5createfolderEx, '<input type=text id=p5renameinput maxlength=64 onkeyup=p5fileNameCheck(event) style=width:100% />'); focusTextBox('p5renameinput'); p5fileNameCheck(); }
        ...
        */
        ...
        function gotoDevice(nodeid, panel, refresh) {
            ...
            if (!currentNode || currentNode._id != node._id || refresh == true) {
                ...
                if ((node.agent != null) && (node.agent.id != null) && (node.mtype == 3)) {
                    if (node.agent.id == 4) { x += addDeviceAttribute("设备类型", "窗口"); }
                ...
                if ((connectivity & 1) != 0) { if (powerstate.length > 0) { powerstate += ', '; } powerstate += ((node.mtype == 4) ? ((node.porttype == 'PDU') ? "转变" : "IP-KVM") : "网格代理"); }
        ...
        var keyStrings = { 8: "退格", 9: "标签", 13: "输入", 27: "逃脱", 44 : "打印屏幕", 45: "插", 46: "德尔", 36: "家", 35: "结尾", 33: "向上翻页", 34: "向下翻页", 37: "剩下", 38: "向上", 39: "正确的", 40: "下", 0: "没有" }

        function keyShortcutTotext(n) {
            var x = [];
            if (n & 0x010000) { x.push("转移"); }
            if (n & 0x020000) { x.push("替代"); }
        ...
        function deskCustomizeKeys() {
            ...
            x += '<label><input id=d1kshift type=checkbox /> ' + "转移" + '</label><label> <input id=d1kalt type=checkbox /> ' + "替代" + '</label><label> <input id=d1kctrl type=checkbox /> ' + "Ctrl" + '</label> <input id=d1kwin type=checkbox /> ' + "Win" + '</label>';
        ...
        */
        ...
        function p13createfolder() { setDialogMode(2, "新建档案夹", 3, p13createfolderEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% />'); focusTextBox('p13renameinput'); p13fileNameCheck(); }
        ...
        function p13uploadFile() { setDialogMode(2, "上载档案", 3, p13uploadFileEx, '<input type=file name=files id=p13uploadinput style=width:100% multiple=multiple onchange="updateUploadDialogOk(\'p13uploadinput\')" />'); updateUploadDialogOk('p13uploadinput'); }
        ...
        function p13viewfile() {
            ...
            for (var i = 0; i < checkboxes.length; i++) {
                if (checkboxes[i].checked) {
                    ...
                    } else { messagebox("档案编辑器", "只能编辑小于200k的档案。"); }
                    break;
                }
            }
        }
        ...
        function p13downloadfile(x, y, z) {
            ...
            setDialogMode(2, "下载档案", 10, p13downloadFileCancel, '<div>' + downloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
        ...
        */
        ...
        function p13doUploadFiles(files) {
            ...
            if (overWriteCount == 0) {
                ...
                setDialogMode(2, "上载档案", 3, p13uploadFileContinue, format((overWriteCount == 1) ? "上传将覆盖1个档案。继续？" : "上传将覆盖{0}个档案。继续？", overWriteCount), files);
            }
        }
        ...
        function p13uploadFileContinue(b, files) {
            ...
            setDialogMode(2, "上载档案", 10, p13uploadFileCancel, '<div id=p13dfileName>' + "正在连线..." + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=0 />');
            p13uploadNextFile();
        }
        ...
        function updateDeviceDetails(node, hardware, network) {
            ...
            if ((hardware.windows && hardware.windows.osinfo) || node.osdesc) {
                ...
                if (node.wsc) {
                    ...
                    if (node.wsc.autoUpdate != null) { if (node.wsc.autoUpdate == 'OK') { y.push("更新资料" + ' - <span style=color:green>' + "OK" + '</span>'); } else { y.push("更新资料" + ' - <span style=color:red>' + "坏的" + '</span>'); } }
            ...
            if (node.agent) {
                ...
                if (x != '') { sections.push({ name: "网格代理", html: x, img: 'meshagent' }); }
            }
            ...
            if (hardware.windows) {
                if (hardware.windows.memory && (hardware.windows.memory.length > 0)) {
                    ...
                    if (x != '') { sections.push({ name: "记忆体", html: x, img: 'ram' }); }
                }
            }
        ...
        */
        ...
        function p15uploadCore2() {
            ...
            Q('d3auth').value = authCookie;
            Q('d3attrib').value = currentNode._id;
            setDialogMode(3, "上载网格代理核心", 3, p15uploadCoreEx2);
            d3init();
        }
        ...
        function p20showAddMeshUserDialog() {
            ...
            x += '<label><input type=checkbox onchange=p20validateAddMeshUserDialog() id=p20meshagentconsole>' + "网格代理控制台" + '</label><br>';
        ...
        function p20viewuser(userid) {
            ...
            if (meshrights == 0xFFFFFFFF) r.push("完整管理员"); else {
                ...
                if ((meshrights & 1024) != 0) r.push("没有档案");
