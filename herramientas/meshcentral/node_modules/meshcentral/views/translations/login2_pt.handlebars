...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" class="arg_hide login">
    ...
    <script>
        ...
        function startup() {
            ...
            var okmessages = ['', "Se válido, redefina o e-mail enviado.", "Email enviado.", "É necessária verificação de e-mail, verifique sua caixa de correio e clique no link de confirmação.", "SMS enviado.", "Enviando notificação ..."];
