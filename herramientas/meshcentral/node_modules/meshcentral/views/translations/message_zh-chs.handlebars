...
<body>
    ...
    <script>
        ...
        switch (msgid) {
            ...
            case 4: { msg = format("用户“ {1} ”的电邮“ {0} ”已通过验证。", arg1, arg2); break; }
            case 5: { msg = format("电邮“ {0} ”已在其他帐户上使用。更改电邮地址，然后重试。", arg1); break; }
            case 6: { msg = format("用户帐户{1}的已验证电邮{0}。", '<b>' + arg1 + '</b>', '<b>' + arg2 + '</b>'); break; }
            case 7: { msg = format("未验证用户“ {1} ”的电邮“ {0} ”。", arg1, arg2); break; }
            case 8: {
