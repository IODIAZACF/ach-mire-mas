    ...
    <div id="p11" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none">
        <div id="deskarea0">
            ...
            <div id="deskarea4" class="areaFoot" style="min-height:24px">
                <div class="toright2">
                    <span id="DeskLatency" title="桌面会话延迟"></span>
                    <span id="DeskTimer" style="display:none" title="会话时间"></span>&nbsp;
    ...
    <div id="p13" class="noselect" style="overflow:hidden;position:absolute;left:54px;top:0;right:0;bottom:0;display:none;background-color:white">
        <div id="p13toolbar" style="position:absolute;left:0;top:0;right:0;bottom:28px">
            ...
            <div id="fileArea2" class="areaHead2" valign="bottom">
                ...
                <div>
                    <input type="button" id="p13FolderUp" disabled="disabled" onclick="p13folderup()" value="向上">&nbsp;
                    ...
                    <input type="button" id="p13NewFolderButton" disabled="disabled" value="新建档案夹" onclick="p13createfolder()">&nbsp;
                    <input type="button" id="p13UploadButton" disabled="disabled" value="上载" onclick="p13uploadFile()">&nbsp;
        ...
        */
        ...
        function p13setActions() {
            ...
            if (p13filetree == null) {
                ...
                Q('p13SelectAllButton').value = (cc > 0 ? "选择无" : "全选");
        ...
        function p13zipFiles() {
            ...
            setDialogMode(2, "邮编档案名", 3, p13zipFilesEx, '<input type=text id=p13renameinput maxlength=64 onkeyup=p13fileNameCheck(event) style=width:100% value="" />', { action: 'zip', path: p13filetreelocation.join('/'), files: inputFiles });
        ...
        function p13downloadfile(x, y, z, tag) {
            ...
            setDialogMode(2, "下载档案", 10, p13downloadFileCancel, '<div>' + gdownloadFile.file + '</div><br /><progress id=d2progressBar style=width:100% value=0 max=' + z + ' />');
        }
