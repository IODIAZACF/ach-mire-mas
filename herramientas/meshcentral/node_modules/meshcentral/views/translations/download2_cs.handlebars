...
<body>
            ...
            <td style="width:100%;text-align:center">
                ...
                <table id="filetable" style="margin: 0 auto;color:#c8c8c8">
                    <tbody><tr>
                        <td>
                            <a id="fileimagelink">
                                <img id="fileimage" src="../../images/login/file48.png" title="Soubor" loading="lazy" width="48" height="48" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:#FFF;margin-right:8px">
                            </a>
                        </td>
        ...
        <tr style="height:20px">
            <td>
                <div>
                    ...
                    <div id="flink" style="float:right;margin-right:4px">{{{rootCertLink}}}&nbsp;<a href="../../terms">Pravidla a ochrana soukromí</a></div>
                </div>
            </td>
        </tr>
    </tbody></table>
    <script>
        ...
        if (messageid == 1) {
            ...
            if (filesize == 1) { QH('filesize', format("1 bajt")); } else { QH('filesize', format("{0} bajtů", filesize)); }
        } else if (messageid == 2) {
            QH('message', "Neplatný odkaz na soubor");
        }
    </script>
