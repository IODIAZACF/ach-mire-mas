...
<body id="body" onload="if (typeof(startup) !== 'undefined') startup();" class="arg_hide login">
    ...
    <table id="centralTable" class="container" style="height:100%;z-index:1">
                ...
                <div id="loginpanel" style="display:none;box-shadow:1px 1px 4px #000">
                    <form id="loginpanelform" method="post">
                        ...
                        <div id="authStrategies" style="display:none">
                            ...
                            <a id="auth-reddit" href="auth-reddit" style="display:none"><img src="images/login/reddit32.png" srcset="images/login/reddit64.png 2x" loading="lazy" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer" title="Přihlaste se pomocí Redditu"></a>
        ...
        <tr style="height:20px">
            <td>
                <div>
                    <div id="flink" style="float:right;margin-right:4px;color:#c8c8c8">{{{rootCertLink}}}&nbsp;<a href="terms">Pravidla a ochrana soukromí</a></div>
    ...
    <script>
        ...
        function startup() {
            ...
            var okmessages = ['', "Pokud je platný, resetujte odeslanou poštu.", "Email odeslán.", "Je vyžadováno ověření e-mailem, zkontrolujte svou poštovní schránku a klikněte na odkaz pro potvrzení.", "SMS odeslána.", "Odesílání oznámení ..."];
