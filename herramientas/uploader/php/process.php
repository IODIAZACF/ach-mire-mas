<?php
  ...
  require( __DIR__ . "/util/uploadfile.php");
  require( __DIR__ . "/util/read_write_functions.php");
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    function saveImagesToTempLocation ($uploadedFile) {
      ...
      if (isset($uploadedFile) && $uploadedFile['error'] === UPLOAD_ERR_OK) {
        ...
        $imageName = uploadFile( $uploadedFile, UPLOAD_DIR);
        ...
        if ($imageName) {
		  ...
		  file_put_contents( __DIR__ . '/info.log', print_r( $newImageInfo, true)  );
		  file_put_contents( __DIR__ . '/params.log', print_r( $_REQUEST, true) , FILE_APPEND );
		  file_put_contents( __DIR__ . '/params.log', print_r( $_SERVER, true) , FILE_APPEND );
