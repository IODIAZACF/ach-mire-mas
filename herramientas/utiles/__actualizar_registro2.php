		...
		if($query[0]->next_record()){
			if($query[0]->xbusca=='-1')
			{
				...
				if(!file_exists( $file_log )){
					file_put_contents($file_log, "id#tiempo#ip#session_id#fecha_ini#fecha_fin#usuario#modulo#script#sql\n");
				}
				...
				$tiempo     = 0;
				$fecha_fin  = 0;
				file_put_contents($file_log, "$tiempo#$ip#$session_id#$fecha_ini#$fecha_fin#$usuario#$modulo#$script#$sql\n", FILE_APPEND);			
			}
