...
if(is_uploaded_file($_FILES['foto']['tmp_name']))
{
    ...
    move_uploaded_file( $recibido , $xruta  . '/' . $ID_M_PRODUCTOS .'_' . $NUMERO . ".jpg" );
    procesar_img($xruta  . '/' . $ID_M_PRODUCTOS . "_" . $NUMERO .".jpg");
...
if($_REQUEST['eliminar']!=''){
	...
	if( file_exists($xruta  . '/' . $ID_M_PRODUCTOS . "_1.jpg") ) $fotos = 1;
	if( file_exists($xruta  . '/' . $ID_M_PRODUCTOS . "_2.jpg") ) $fotos = 2;
	if( file_exists($xruta  . '/' . $ID_M_PRODUCTOS . "_3.jpg") ) $fotos = 3;
	if( file_exists($xruta  . '/' . $ID_M_PRODUCTOS . "_4.jpg") ) $fotos = 4;
	if( file_exists($xruta  . '/' . $ID_M_PRODUCTOS . "_5.jpg") ) $fotos = 5;
...
if(file_exists($xruta  . '/' . $ID_M_PRODUCTOS . "_" . $NUMERO . ".jpg"))
{
    srand((double)microtime()*1000000);
    $randval = rand();
    $img_productos = '<img src="'. $xruta  . '/' . $ID_M_PRODUCTOS . "_" . $NUMERO . ".jpg" . '?rnd='. $randval  .'" border="0" width="250px">' . "\n";
}
else
{
    srand((double)microtime()*1000000);
...
<form name="imagen_producto" id="imagen_producto" action="?ID_M_PRODUCTOS={$ID_M_PRODUCTOS}&NUMERO={$NUMERO}" method="post" enctype="multipart/form-data">
