...
const startSock = async() => {
	...
	*/
	sock.ev.on('messages.upsert', async m => {
		...
		//const id = '593960163222@s.whatsapp.net'
		//sock.sendMessage(m.messages[0].key.remoteJid, { location: { degreesLatitude: 24.121231, degreesLongitude: 55.1121221 } })
...
app.post('/enviar', (req, res) => {
	...
	sock.sendMessage(id, mensaje).then(( sentMsg )=>{
