...
m_test              = new lista('modulo_base_02/m_test');
...
d_test            = new lista('modulo_base_02/d_test');
...
function t_m_test(objeto, tecla, xml, e)
{
	...
	switch (tecla)
	{
		...
		case _supr:
			...
			var param = "origen=modulo_base_02/m_test&procedimiento=ELIMINAR_ITEM&ID_M_TEST=" + registro[0]['ID_M_TEST'];
...
function t_d_test(objeto, tecla, xml, e)
{
	...
	case _supr:
		...
		{
		var url   = server_path + "herramientas/utiles/actualizar_registro.php";
		var param = "origen=modulo_base_02/d_test&procedimiento=ELIMINAR_ITEM&ID_D_TEST=" + registro[0]['ID_D_TEST'];
		var x     = enviar(url,param,'POST');
		}
		d_test.buscar('*');
	break;
