...
$query->ejecuta_query();
$query->next_record();
$xid_m_configuracion 	 = $query->Record['ID_CONFIGURACION'];
...
var  xid_m_configuracion =  '{$xid_m_configuracion}';
...
f_configuracion              = new formulario2('configuracion/f_configuracion');
...
function t_f_configuracion(elemento, tecla)
{
  switch (tecla)
  {
    case _f12: // Guardar
   ...
   case _esc: // Cerrar Formulario
      	ocultar_formulario(f_configuracion);
        Salir();
    break;
  }
}
...
function iniciar()
{
  ...
  f_configuracion.buscar(xid_m_configuracion);
