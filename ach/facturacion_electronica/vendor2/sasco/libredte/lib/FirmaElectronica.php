...
class FirmaElectronica
{
	...
	$X509SerialNumber ='1532882968';
		...
		$SignedInfo .= add('	<ds:CanonicalizationMethod Algorithm="http://www.w3.org/TR/2001/REC-xml-c14n-20010315" />') .$sep;
		//$SignedInfo .= add('	</ds:CanonicalizationMethod>');
		$SignedInfo .= add('	<ds:SignatureMethod Algorithm="http://www.w3.org/2000/09/xmldsig#rsa-sha1" />') . $sep;
		...
		$SignedInfo .= add('			<ds:Transform Algorithm="http://www.w3.org/2000/09/xmldsig#enveloped-signature" />') .$sep;
