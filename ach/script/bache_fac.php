...
//$xsql          = "SELECT ID_M_DOCUMENTOS,ID_M_PRODUCTOS,ID_D_DOCUMENTOS,CANTIDAD,PRECIO,DESCUENTO,ID_I_PROD_ALMA,TIPO,IMPUESTO,NOMBRE_IMPUESTO,COSTO,COSTO_PROMEDIO FROM D_DOCUMENTOS WHERE ID_M_ARCHIVOS='" . $xid . "'";

$xsql="SELECT TIPO,ID_M_PRODUCTOS,SUM(CANTIDAD) CANTIDAD,DESCRIPCION,COSTO,COSTO_PROMEDIO,PRECIO,IMPUESTO FROM V_D_DOCUMENTOS_FAC_BACHE
WHERE ID_M_ARCHIVOS='$xid'
GROUP BY TIPO,ID_M_PRODUCTOS,DESCRIPCION,COSTO,COSTO_PROMEDIO,PRECIO,IMPUESTO
