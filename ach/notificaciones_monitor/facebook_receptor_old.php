...
file_put_contents(__DIR__ .'/log/facebook.txt', print_r($param, true), FILE_APPEND);
file_put_contents(__DIR__ .'/log/facebook.txt', "\n\n", FILE_APPEND);

    $verify_token = '424639';
    $token = 'EAAltcmBpDHUBAL1DWe8wv4u8r0D15BNMw1QTMPzoDsxSCmMo2OvXeezWP06n1ZBtiRGtjmnRNMdBc0s3Yt0NybJFOGXfU9Qhy427ZAeLoMx7IZBpgbKH2ssW4TrBs13wdLGnAQ3lZCAWzM9rI8F6I9YJxuZBKTeg3ge2pm8hkdAZDZD';
