...
function t_MENU_PRINCIPAL(obj, tecla){
	switch(tecla){
		...
		case 'graficos_alerta': 	// Graficos Alerta
			cargar_pagina('/graficos/', {filtro:'ALERTA'} );
		break;

		case 'graficos_ern': 		// Graficos ERN
			cargar_pagina('/graficos/', {filtro:'ERN'} );
		break;

		case 'graficos_cierre': 	// Graficos Cierre
			cargar_pagina('/graficos/', {filtro:'CIERRE'} );
		break;
		
		case 'graficos_lpa': 	// Graficos Lpa
			cargar_pagina('/graficos/', {filtro:'LPA'} );
		break;
