...
m_kobo_formularios              = new lista('auditoria_formularios/m_kobo_formularios');
...
m_kobo_respuestas            = new lista('auditoria_formularios/m_kobo_respuestas');
...
f_m_kobo_formularios 			   = new formulario2('auditoria_formularios/f_m_kobo_formularios');
...
f_m_kobo_respuestas 			  = new formulario2('auditoria_formularios/f_m_kobo_respuestas');
...
f_m_kobo_formularios_test 			   = new formulario2('auditoria_formularios/f_m_kobo_formularios_test');
...
function Crear_archivo() {
	$.download(server_path + 'auditoria_formularios/descargar_formulario.php','ID_M_KOBO_FORMULARIOS='+xID_M_KOBO_FORMULARIOS);
}
	...
	switch (tecla) 	{
		...
		case _f9:
			...
			if( confirm('Desea pasar el estatus del formulario a Anulado ?') ){
				fs.armar('auditoria_formularios/fs_estatus');
